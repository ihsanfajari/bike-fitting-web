...
import { getListing, LISTINGS } from "../../marketplace/_lib/mock-data";
...
export default async function MCheckoutPage({
  ...
  return (
    <>
      <PageTopBar title="Checkout" backHref={`/m/listing/${listing.slug}`} />
      ...
      <div className="sticky bottom-0 z-30 bg-[var(--color-m-paper)] border-t border-[var(--color-m-ink-100)] px-4 py-3 m-shadow-lg">
        ...
        <Link
          href={`/m/checkout/payment?listing=${listing.id}`}
