...
import {
  ...
  getSeller,
  LISTINGS,
} from "../../../marketplace/_lib/mock-data";
    ...
    <>
      ...
      <main className="flex-1 pb-32">
        ...
        {seller && (
          <section className="bg-[var(--color-m-paper)] px-5 py-5 mt-3">
            ...
            <Link href={`/m/seller/${seller.id}`} className="flex items-center gap-3">
      ...
      <div className="sticky bottom-0 z-30 bg-[var(--color-m-paper)] border-t border-[var(--color-m-ink-100)] px-4 py-3 m-shadow-lg">
        <div className="flex items-center gap-2">
          ...
          <Link
            href={`/m/chat/new?listing=${listing.id}`}
          ...
          <Link
            href={`/m/checkout?listing=${listing.id}`}
