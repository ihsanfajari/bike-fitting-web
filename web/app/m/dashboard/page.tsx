...
import { LISTINGS, ORDERS, getListing } from "../../marketplace/_lib/mock-data";
...
import { formatRupiah, formatRupiahShort } from "../_lib/format";
...
export default function MDashboardPage() {
  ...
  return (
    <>
      <PageTopBar title="Dashboard Penjual" backHref="/m" />
      ...
      <main className="flex-1 pb-6 bg-[var(--color-m-cream)]">
        ...
        <section className="px-5 py-4">
          <div className="grid grid-cols-4 gap-2">
            <QuickAction icon={<IconPlus size={20} />} label="Listing" href="/m/sell" accent />
            <QuickAction icon={<IconBox size={20} />} label="Pesanan" href="/m/orders" badge={pendingActions} />
            <QuickAction icon={<IconChat size={20} />} label="Chat" href="/m/chat" badge={3} />
            <QuickAction icon={<IconHeart size={20} />} label="Promosi" href="/m/promo" />
          </div>
        </section>
        ...
        {pendingActions > 0 && (
          <section className="px-5 pb-5">
            <div className="flex items-center justify-between mb-3">
              ...
              <Link href="/m/orders" className="text-[12px] font-semibold text-[var(--color-m-orange-600)] inline-flex items-center gap-0.5">
        ...
        <section className="px-5 pb-6">
          <div className="flex items-center justify-between mb-3">
            ...
            <Link href="/m/me/listings" className="text-[12px] font-semibold text-[var(--color-m-orange-600)] inline-flex items-center gap-0.5">
